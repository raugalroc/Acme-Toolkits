...
<acme:form>
	...
	<acme:input-double code="any.toolkit.form.label.total-price" path="totalPrice" readonly="true"/>
	<acme:button code="any.toolkit.form.button.inventions" action="/any/invention/list-invention-toolkit?id=${id}"/>
