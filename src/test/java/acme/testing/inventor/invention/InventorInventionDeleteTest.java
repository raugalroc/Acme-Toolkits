...
public class InventorInventionDeleteTest extends TestHarness{
	
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/invention/positive-delete-component.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	public void positiveTestComponent(final int recordIndex, final String name, final String code, final String technology, final String description, final String retailPrice, final String link, final String inventionType, final String published) {
		...
		super.clickOnSubmit("Delete Invention");
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/invention/negative-delete-component.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(20)
	public void negativeTestComponent(final int recordIndex, final String name, final String code, final String technology, final String description, final String retailPrice, final String link, final String inventionType, final String published) {
		...
		super.checkNotButtonExists("Delete Invention");
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/invention/positive-delete-tool.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(30)
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/inventor/invention/negative-delete-tool.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(40)
